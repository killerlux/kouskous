...
Flutter app for drivers to receive ride offers and manage earnings.
...
The driver app uses background location tracking when online. Make sure to:
- Grant location permissions
- Configure foreground service (Android)
- Enable background location (iOS)
