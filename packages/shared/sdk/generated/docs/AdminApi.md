...
|[**adminDriversIdVerifyPost**](#admindriversidverifypost) | **POST** /admin/drivers/{id}/verify | Approve/reject driver verification (admin)|
|[**adminVerificationQueueGet**](#adminverificationqueueget) | **GET** /admin/verification-queue | Get pending driver verifications (admin)|
...
# **adminDriversIdVerifyPost**
> adminDriversIdVerifyPost(adminDriversIdVerifyPostRequest)
...
import {
    AdminApi,
    Configuration,
    AdminDriversIdVerifyPostRequest
} from './api';
...
let adminDriversIdVerifyPostRequest: AdminDriversIdVerifyPostRequest; //

const { status, data } = await apiInstance.adminDriversIdVerifyPost(
    id,
    adminDriversIdVerifyPostRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **adminDriversIdVerifyPostRequest** | **AdminDriversIdVerifyPostRequest**|  | |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
|**204** | Verification updated |  -  |
|**403** | Not admin |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **adminVerificationQueueGet**
> adminVerificationQueueGet()
...
const { status, data } = await apiInstance.adminVerificationQueueGet(
    page,
    limit
);
```
